export default function About() {
    ...
    return (
        <>
            <section id={"about"}>
                <div className={"bg-slate-600 text-white p-4 py-8 md:p-14 md:py-20 w-full flex flex-col"}>
                    <h1 className={"font-bold text-2xl md:text-3xl lg:text-4xl mb-8"}>
                        ...
                        <div className={"md:w-2/4 mr-20"}>
                            ...
                            <a href="https://www.buymeacoffee.com/vibovenkat" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" className="w-32"/></a>
                        </div>
